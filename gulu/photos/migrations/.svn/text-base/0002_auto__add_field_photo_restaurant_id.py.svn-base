...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.restaurant_id'
        db.add_column('photos_photo', 'restaurant_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.restaurant_id'
        db.delete_column('photos_photo', 'restaurant_id')
