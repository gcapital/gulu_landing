...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('review_review', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.title'
        db.delete_column('review_review', 'title')
