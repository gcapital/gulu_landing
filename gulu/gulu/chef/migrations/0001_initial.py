...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Chef'
        db.create_table('chef_chef', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('restaurant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='chefs', to=orm['restaurant.Restaurant'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('chef', ['Chef'])


    def backwards(self, orm):
        
        # Deleting model 'Chef'
        db.delete_table('chef_chef')
    ...
    models = {
        ...
        'chef.chef': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'chefs'", 'to': "orm['restaurant.Restaurant']"})
        },
