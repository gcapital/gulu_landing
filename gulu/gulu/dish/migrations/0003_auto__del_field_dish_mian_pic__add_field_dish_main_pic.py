...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dish.main_pic'
        db.add_column('dish_dish', 'main_pic', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dish_dish_main_pic_dish', null=True, to=orm['photos.Photo']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Dish.mian_pic'
        db.add_column('dish_dish', 'mian_pic', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dish_dish_main_pic_dish', null=True, to=orm['photos.Photo'], blank=True), keep_default=False)

        # Deleting field 'Dish.main_pic'
        db.delete_column('dish_dish', 'main_pic_id')
