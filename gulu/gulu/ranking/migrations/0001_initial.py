...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DishRankingRecord'
        db.create_table('ranking_dishrankingrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dish.Dish'])),
            ...
            ('activity', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('num_photo', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('ranking', ['DishRankingRecord'])


    def backwards(self, orm):
        
        # Deleting model 'DishRankingRecord'
        db.delete_table('ranking_dishrankingrecord')
    ...
    models = {
        ...
        'ranking.dishrankingrecord': {
            'Meta': {'ordering': "['-score']", 'object_name': 'DishRankingRecord'},
            'activity': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'comment': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dish.Dish']"}),
            'num_photo': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
