...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field syncs on 'UserProfile'
        db.create_table('user_profiles_userprofile_syncs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['user_profiles.userprofile'], null=False)),
            ('sync', models.ForeignKey(orm['piston.sync'], null=False))
        ))
        db.create_unique('user_profiles_userprofile_syncs', ['userprofile_id', 'sync_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field syncs on 'UserProfile'
        db.delete_table('user_profiles_userprofile_syncs')
