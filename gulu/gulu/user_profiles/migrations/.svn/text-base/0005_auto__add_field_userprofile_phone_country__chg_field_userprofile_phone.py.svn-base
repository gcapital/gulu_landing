...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.phone_country'
        db.add_column('user_profiles_userprofile', 'phone_country', self.gf('django.db.models.fields.CharField')(max_length=6, null=True), keep_default=False)

        # Changing field 'UserProfile.phone'
        db.alter_column('user_profiles_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.phone_country'
        db.delete_column('user_profiles_userprofile', 'phone_country')

        # Changing field 'UserProfile.phone'
        db.alter_column('user_profiles_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
