...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Sync.type_id'
        db.delete_column('piston_sync', 'type_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Sync.type_id'
        db.add_column('piston_sync', 'type_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1297414377L'}),
