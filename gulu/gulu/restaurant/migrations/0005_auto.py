...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field best_photos on 'Restaurant'
        db.create_table('restaurant_restaurant_best_photos', (
        ...
        db.create_unique('restaurant_restaurant_best_photos', ['restaurant_id', 'photo_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field best_photos on 'Restaurant'
        db.delete_table('restaurant_restaurant_best_photos')
    ...
    models = {
        ...
        'restaurant.restaurant': {
            ...
            'location_group_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'review.review': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'photo_review_related'", 'null': 'True', 'to': "orm['photos.Photo']"}),
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.Restaurant']"}),
