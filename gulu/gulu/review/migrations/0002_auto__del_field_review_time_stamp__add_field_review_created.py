...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Review.time_stamp'
        db.delete_column('review_review', 'time_stamp')

        # Adding field 'Review.created'
        db.add_column('review_review', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Review.time_stamp'
        db.add_column('review_review', 'time_stamp', self.gf('django.db.models.fields.TimeField')(auto_now_add=True, default=datetime.datetime.now), keep_default=False)

        # Deleting field 'Review.created'
        db.delete_column('review_review', 'created')
