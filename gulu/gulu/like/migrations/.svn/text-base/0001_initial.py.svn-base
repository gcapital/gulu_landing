...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('like', ['Like'])

        # Adding unique constraint on 'Like', fields ['user', 'content_type', 'object_id']
        db.create_unique('like_like', ['user_id', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Like', fields ['user', 'content_type', 'object_id']
        db.delete_unique('like_like', ['user_id', 'content_type_id', 'object_id'])

        # Deleting model 'Like'
        db.delete_table('like_like')
    ...
    models = {
        ...
        'like.like': {
            'Meta': {'ordering': "['-created']", 'unique_together': "(('user', 'content_type', 'object_id'),)", 'object_name': 'Like'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
