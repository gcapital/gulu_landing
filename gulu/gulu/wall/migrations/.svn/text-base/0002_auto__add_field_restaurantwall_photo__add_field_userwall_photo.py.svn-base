...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RestaurantWall.photo'
        db.add_column('wall_restaurantwall', 'photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'], null=True, blank=True), keep_default=False)

        # Adding field 'UserWall.photo'
        db.add_column('wall_userwall', 'photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RestaurantWall.photo'
        db.delete_column('wall_restaurantwall', 'photo_id')

        # Deleting field 'UserWall.photo'
        db.delete_column('wall_userwall', 'photo_id')
    ...
    models = {
        ...
        'restaurant.restaurant': {
            ...
            'best_photos': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'best_photo_restaurant'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['photos.Photo']"}),
        ...
        'wall.restaurantwall': {
            ...
            'content': ('django.db.models.fields.TextField', [], {}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 25, 21, 42, 22, 453704)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'total_comment': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 25, 21, 42, 22, 453750)'})
        },
        'wall.userwall': {
