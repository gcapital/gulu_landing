...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RestaurantPost'
        db.create_table('blog_restaurantpost', (
            ...
            ('restaurant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts', to=orm['restaurant.Restaurant'])),
        ))
        db.send_create_signal('blog', ['RestaurantPost'])

        # Adding model 'UserPost'
        db.create_table('blog_userpost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profiles.UserProfile'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts', to=orm['user_profiles.UserProfile'])),
        ))
        db.send_create_signal('blog', ['UserPost'])


    def backwards(self, orm):
        
        # Deleting model 'RestaurantPost'
        db.delete_table('blog_restaurantpost')

        # Deleting model 'UserPost'
        db.delete_table('blog_userpost')
    ...
    models = {
        ...
        'blog.restaurantpost': {
            'Meta': {'object_name': 'RestaurantPost'},
            'content': ('django.db.models.fields.TextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'poster': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_profiles.UserProfile']"}),
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'posts'", 'to': "orm['restaurant.Restaurant']"}),
        ...
        'blog.userpost': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'posts'", 'to': "orm['user_profiles.UserProfile']"}),
            'poster': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_profiles.UserProfile']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
