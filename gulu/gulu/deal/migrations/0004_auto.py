...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field restaurants on 'Deal'
        db.create_table('deal_deal_restaurants', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('deal', models.ForeignKey(orm['deal.deal'], null=False)),
            ('restaurant', models.ForeignKey(orm['restaurant.restaurant'], null=False))
        ))
        db.create_unique('deal_deal_restaurants', ['deal_id', 'restaurant_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field restaurants on 'Deal'
        db.delete_table('deal_deal_restaurants')
