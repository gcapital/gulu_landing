...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Deal.cover'
        db.add_column('deal_deal', 'cover', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Deal.cover'
        db.delete_column('deal_deal', 'cover_id')
