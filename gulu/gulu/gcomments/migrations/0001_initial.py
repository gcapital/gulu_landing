...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GComment'
        db.create_table('gcomments_gcomment', (
            ('comment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['comments.Comment'], unique=True, primary_key=True)),
            ('commenter', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='gcomment_comments', null=True, to=orm['user_profiles.UserProfile'])),
        ))
        db.send_create_signal('gcomments', ['GComment'])


    def backwards(self, orm):
        
        # Deleting model 'GComment'
        db.delete_table('gcomments_gcomment')
    ...
    models = {
        ...
        'gcomments.gcomment': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'GComment', '_ormbases': ['comments.Comment']},
            'comment_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['comments.Comment']", 'unique': 'True', 'primary_key': 'True'}),
            'commenter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'gcomment_comments'", 'null': 'True', 'to': "orm['user_profiles.UserProfile']"})
        },
        'sites.site': {
