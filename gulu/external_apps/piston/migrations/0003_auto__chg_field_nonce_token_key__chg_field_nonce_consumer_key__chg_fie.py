...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Nonce.token_key'
        db.alter_column('piston_nonce', 'token_key', self.gf('django.db.models.fields.CharField')(max_length=18))

        # Changing field 'Nonce.consumer_key'
        db.alter_column('piston_nonce', 'consumer_key', self.gf('django.db.models.fields.CharField')(max_length=18))

        # Changing field 'Consumer.secret'
        db.alter_column('piston_consumer', 'secret', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Consumer.key'
        db.alter_column('piston_consumer', 'key', self.gf('django.db.models.fields.CharField')(max_length=18))

        # Changing field 'Site.secret'
        db.alter_column('piston_site', 'secret', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Site.key'
        db.alter_column('piston_site', 'key', self.gf('django.db.models.fields.CharField')(max_length=18))

        # Changing field 'Site.api_key'
        db.alter_column('piston_site', 'api_key', self.gf('django.db.models.fields.CharField')(max_length=18, null=True))

        # Changing field 'Token.secret'
        db.alter_column('piston_token', 'secret', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Token.verifier'
        db.alter_column('piston_token', 'verifier', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Token.key'
        db.alter_column('piston_token', 'key', self.gf('django.db.models.fields.CharField')(max_length=18))

        # Changing field 'Sync.verifier'
        db.alter_column('piston_sync', 'verifier', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Sync.token'
        db.alter_column('piston_sync', 'token', self.gf('django.db.models.fields.CharField')(max_length=18))

        # Changing field 'Sync.token_secret'
        db.alter_column('piston_sync', 'token_secret', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    models = {
        ...
        'piston.nonce': {
            ...
            'consumer_key': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'token_key': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        'piston.site': {
            'Meta': {'object_name': 'Site'},
            'access_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'api_key': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
        ...
        'piston.sync': {
            ...
            'token_secret': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_profiles.UserProfile']"}),
            'verifier': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'})
        },
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1296444394L'}),
            'token_type': ('django.db.models.fields.IntegerField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tokens'", 'null': 'True', 'to': "orm['auth.User']"}),
            'verifier': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
