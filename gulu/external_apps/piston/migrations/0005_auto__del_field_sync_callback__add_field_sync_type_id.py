...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Sync.callback'
        db.delete_column('piston_sync', 'callback')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Sync.callback'
        db.add_column('piston_sync', 'callback', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'piston.sync': {
            ...
            'type_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1296525804L'}),
