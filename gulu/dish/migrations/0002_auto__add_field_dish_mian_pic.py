...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dish.mian_pic'
        db.add_column('dish_dish', 'mian_pic', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dish_dish_main_pic_dish', null=True, to=orm['photos.Photo']), keep_default=False)

        # Adding M2M table for field dish_pics on 'Dish'
        db.create_table('dish_dish_dish_pics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dish', models.ForeignKey(orm['dish.dish'], null=False)),
            ('photo', models.ForeignKey(orm['photos.photo'], null=False))
        ))
        db.create_unique('dish_dish_dish_pics', ['dish_id', 'photo_id'])


    def backwards(self, orm):
        
        # Deleting field 'Dish.mian_pic'
        db.delete_column('dish_dish', 'mian_pic_id')

        # Removing M2M table for field dish_pics on 'Dish'
        db.delete_table('dish_dish_dish_pics')
    ...
    models = {
        ...
        'dish.dish': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mian_pic': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'dish_dish_main_pic_dish'", 'null': 'True', 'to': "orm['photos.Photo']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
