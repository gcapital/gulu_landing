...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.gulu_url'
        db.add_column('piston_site', 'gulu_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'Sync.url'
        db.delete_column('piston_sync', 'url')

        # Deleting field 'Sync.type'
        db.delete_column('piston_sync', 'type')


    def backwards(self, orm):
        
        # Deleting field 'Site.gulu_url'
        db.delete_column('piston_site', 'gulu_url')

        # Adding field 'Sync.url'
        db.add_column('piston_sync', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Sync.type'
        db.add_column('piston_sync', 'type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'piston.site': {
            ...
            'gulu_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1297418405L'}),
        ...
        'user_profiles.userprofile': {
            ...
            'syncs': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'user_profile_syncs'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['piston.Sync']"}),
