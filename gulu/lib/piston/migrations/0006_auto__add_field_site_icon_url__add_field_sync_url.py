...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.icon_url'
        db.add_column('piston_site', 'icon_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Site.icon_url'
        db.delete_column('piston_site', 'icon_url')
    ...
    models = {
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1297411888L'}),
