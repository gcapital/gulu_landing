...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.api_key'
        db.add_column('piston_site', 'api_key', self.gf('django.db.models.fields.CharField')(max_length=18, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.api_key'
        db.delete_column('piston_site', 'api_key')
    ...
    models = {
        ...
        'piston.site': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'max_length': '18', 'null': 'True', 'blank': 'True'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1296442090L'}),
