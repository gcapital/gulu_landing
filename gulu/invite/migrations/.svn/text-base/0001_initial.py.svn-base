...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invite_invite', (
            ...
            ('inviter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profiles.UserProfile'])),
            ('total_user_sms', self.gf('django.db.models.fields.IntegerField')()),
            ('total_other_sms', self.gf('django.db.models.fields.IntegerField')()),
            ('total_user_invite', self.gf('django.db.models.fields.IntegerField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('invite', ['Invite'])

        # Adding model 'InviteList'
        db.create_table('invite_invitelist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invite', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invite.Invite'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profiles.UserProfile'], null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sms', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('invite', ['InviteList'])


    def backwards(self, orm):
        
        # Deleting model 'Invite'
        db.delete_table('invite_invite')

        # Deleting model 'InviteList'
        db.delete_table('invite_invitelist')
    ...
    models = {
        ...
        'invite.invite': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inviter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_profiles.UserProfile']"}),
            'message': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.Restaurant']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'total_other_sms': ('django.db.models.fields.IntegerField', [], {}),
            'total_user_invite': ('django.db.models.fields.IntegerField', [], {}),
            'total_user_sms': ('django.db.models.fields.IntegerField', [], {})
        },
        'invite.invitelist': {
            'Meta': {'object_name': 'InviteList'},
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['invite.Invite']"}),
            'sms': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
