...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OtherLocation'
        db.create_table('locations_otherlocation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('to_restaurant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='other_locations', to=orm['restaurant.Restaurant'])),
            ('from_restaurant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_unused_', to=orm['restaurant.Restaurant'])),
            ('added', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
        ))
        db.send_create_signal('locations', ['OtherLocation'])

        # Adding unique constraint on 'OtherLocation', fields ['to_restaurant', 'from_restaurant']
        db.create_unique('locations_otherlocation', ['to_restaurant_id', 'from_restaurant_id'])

        # Adding model 'OtherLocationInvitation'
        db.create_table('locations_otherlocationinvitation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_restaurant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invitations_from', to=orm['restaurant.Restaurant'])),
            ('to_restaurant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invitations_to', to=orm['restaurant.Restaurant'])),
            ('sent', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('locations', ['OtherLocationInvitation'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OtherLocation', fields ['to_restaurant', 'from_restaurant']
        db.delete_unique('locations_otherlocation', ['to_restaurant_id', 'from_restaurant_id'])

        # Deleting model 'OtherLocation'
        db.delete_table('locations_otherlocation')

        # Deleting model 'OtherLocationInvitation'
        db.delete_table('locations_otherlocationinvitation')
    ...
    models = {
        ...
        'locations.otherlocation': {
            'Meta': {'unique_together': "(('to_restaurant', 'from_restaurant'),)", 'object_name': 'OtherLocation'},
            'added': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
            'from_restaurant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_unused_'", 'to': "orm['restaurant.Restaurant']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'to_restaurant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'other_locations'", 'to': "orm['restaurant.Restaurant']"})
        },
        'locations.otherlocationinvitation': {
            'Meta': {'object_name': 'OtherLocationInvitation'},
            'from_restaurant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invitations_from'", 'to': "orm['restaurant.Restaurant']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sent': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
            'status': ('django.db.models.fields.IntegerField', [], {}),
            'to_restaurant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invitations_to'", 'to': "orm['restaurant.Restaurant']"})
        },
