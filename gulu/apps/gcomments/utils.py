""" Decorators for handling AJAX comment posts """

# Based on Brandon Konkle's django-ajaxcomments <http://bitbucket.org/bkonkle/django-ajaxcomments/>

__author__ = "Ben Homnick <bhomnick@gmail.com>"
__version__ = "$Id: utils.py 618 2011-01-27 09:57:59Z ben $"
...
def jsonify_if_ajax(func, request):
	...
	def wrapped(*args, **kwargs):
		if request.is_ajax():
			...
			comment_html = None
			if 'c' in kwargs:
				comment_html = render_to_string('inc_gcomments_comment.html',
												{'comment': GComment.objects.get(id=kwargs['c']) },
