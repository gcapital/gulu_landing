...
class Sync(models.Model):
    ...
    def icon_url(self):
        return self.site.icon_url
    def url(self):
        return self.site.gulu_url
    def type(self):
...
class Site(models.Model):
    ...
    gulu_url = models.CharField(max_length=255, null=True, blank=True)
    key = models.CharField(max_length=KEY_SIZE)
    secret = models.CharField(max_length=SECRET_SIZE)
    api_key = models.CharField(max_length=KEY_SIZE, null=True, blank=True)
    def __unicode__(self):
        return u"Site %s with oauth service" % (self.name)
