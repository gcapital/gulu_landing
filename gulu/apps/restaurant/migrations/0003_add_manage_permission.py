...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        #	name = "Can manage restaurant",
        #	content_type = orm['contenttypes.ContentType'].objects.get(app_label="restaurant", 
        #		model="restaurant"), 
    ...
    def backwards(self, orm):
        orm['auth.Permission'].objects.get(codename="manage_restaurant").delete()
