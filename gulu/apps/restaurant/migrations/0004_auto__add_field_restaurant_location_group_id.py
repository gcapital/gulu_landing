...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Restaurant.location_group_id'
        db.add_column('restaurant_restaurant', 'location_group_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Restaurant.location_group_id'
        db.delete_column('restaurant_restaurant', 'location_group_id')
