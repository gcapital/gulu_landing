...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('review_review', (
            ...
            ('dish', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dish.Dish'], null=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('total_comment', self.gf('django.db.models.fields.IntegerField')()),
            ('time_stamp', self.gf('django.db.models.fields.TimeField')(auto_now_add=True)),
        ))
        db.send_create_signal('review', ['Review'])

        # Adding model 'ReviewHelpul'
        db.create_table('review_reviewhelpul', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('review', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.Review'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profiles.UserProfile'])),
            ('helpful_yes', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('helpful_no', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('time_stamp', self.gf('django.db.models.fields.TimeField')(auto_now_add=True)),
        ))
        db.send_create_signal('review', ['ReviewHelpul'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ReviewHelpul'
        db.delete_table('review_reviewhelpul')
